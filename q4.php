                        ...
                        <form id="form1" role="form" action="/?formFlowConfigId=2113&amp;estprg=1&amp;viewType=FULL&amp;__submit=1" method="post" onsubmit="self.exitPop['ClicksNet'].submitButtonClick('ClicksNet')">
                            <div class="content" id="form-content">
                                ...
                                <div class="field-groups" id="field-groups">
                                    <fieldset class="field-group" id="SPEC_HOME_FIELD_GROUP" style="display: block;"><br>
                                        <div id="container-outer-header-SPEC_HOME" class="container-outer-header">
                                            <h3>Have you found a home?</h3>
                                        </div>
                                        <div class="form-group" id="SPEC_HOME_FIELD_GROUP_FORM_GROUP">
                                            <div id="SPEC_HOME_FIELD_GROUP_FORM_GROUP_SPEC_HOME_FIELD_LABEL_PAIR" class="field-label-pair valid">
                                                <div id="error-message-SPEC_HOME" class="error-message loc-top" style="display: none;"></div>
                                                <div class="" id="FIELD-BODY-SPEC_HOME"><input type="hidden" id="SPEC_HOME" name="SPEC_HOME" value="no" maxlength="" class="" placeholder="">
                                                    <div class="" id="SPEC_HOME_OUTER_GROUP">
                                                        <div class="btn-group" id="SPEC_HOME_INNER_GROUP">
                                                            <a href="q4-2">
                                                                <div class="centered mb20" id="spec-home-yes-btn-group"><button type="button" id="spec-home-yes-btn" class="green-btn" target="SPEC_HOME" value="yes">Yes</button></div>
                                                            </a>
                                                            <a href="q5">
                                                                <div class="centered mb20" id="spec-home-no-btn-group"><button type="button" id="spec-home-no-btn" class="green-btn " target="SPEC_HOME" selectedvalue="no">No</button></div>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div id="submit-button-container" class="submit-btn-group column-1-1 abs-position">
                                <div id="back_button_group" style="margin-top: 21px; text-align: center;">
                                    <a class="btn green-back-btn" href="q3"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i>Back</a>
                                </div>
                            </div>
                        </form>
                    </div>
